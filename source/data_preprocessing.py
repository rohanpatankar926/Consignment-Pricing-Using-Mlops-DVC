...
class Preprocessing:
    ...
    def column_imputation(self,config_path):
        try:
            ...
            self.logger.log(log_file,"column_imputation function compiled successfully")
            return self.data
    ...
    def impute_missing(self,config_path):
        try:
            ...
            self.logger.log(log_file,"impute_missing function compiled successfully")
            return self.data
        except Exception as e:
            self.logger.log(log_file,"Exception occurred while compiling the code",str(e))
            self.logger.log("Failed to execute the code please check your code and run")
    ...
    def transform_pq_first_sent_to_client_date_columns(self,config_path):
        try:
            log_file=open("logs/preprocessing_logs.logs","a+")
            self.logger.log(log_file,"'transform_pq_first_sent_to_client_date_columns' FUNCTION STARTED")
            ...
            self.logger.log(log_file,"transform_pq_first_sent_to_client_date_columns function compiled successfully")
            return self.data
        except Exception as e:
            self.logger.log(log_file,"Exception occurred while compiling the code",str(e))
            self.logger.log("Failed to execute the code please check your code and run")
    ...
    def transform_dates_columns(self,config_path):
        try:
            log_file=open("logs/preprocessing_logs.logs","a+")
            self.logger.log(log_file,"'transform_dates_columns' FUNCTION STARTED")
            self.data=self.transform_pq_first_sent_to_client_date_columns(config_path)
            ...
            self.logger.log(log_file,"transform_dates_columns function compiled successfully")
            return self.data
        except Exception as e:
            self.logger.log(log_file,"Exception occurred while compiling the code",str(e))
            self.logger.log("Failed to execute the code please check your code and run")
    ...
    def transform_freight_cost_columns(self,config_path):
        try:
            log_file=open("logs/preprocessing_logs.logs","a+")
            self.logger.log(log_file,"'transform_freight_cost_columns' FUNCTION STARTED")
            ...
            self.logger.log(log_file,"transform_freight_cost_columns function compiled successfully")
            return self.data
        except Exception as e:
            self.logger.log(log_file,"Exception occurred while compiling the code",str(e))
            self.logger.log("Failed to execute the code please check your code and run")
    ...
    def drop_unnecessary_columns(self,config_path):
        try:
            log_file=open("logs/preprocessing_logs.logs","a+")
            self.logger.log(log_file,"'drop_unnecessary_columns' FUNCTION STARTED")
            self.config=self.get_data.read_params(config_path)
            self.data=self.transform_dates_columns(config_path)        
            self.data=self.data[self.config["columns"]["select"]]
            self.logger.log(log_file,"drop_unnecessary_columns function compiled successfully")
            return self.data
        except Exception as e:
            self.logger.log(log_file,"Exception occurred while compiling the code",str(e))
            self.logger.log("Failed to execute the code please check your code and run")
